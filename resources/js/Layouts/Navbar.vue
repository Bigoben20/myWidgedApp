<template>
    <nav class="flex flex-no-wrap items-center justify-between w-full py-4 shadow-md bg-neutral-100/20 shadow-black/5 dark:bg-neutral-600/20 dark:shadow-black/10 backdrop-blur-sm lg:flex-wrap lg:justify-start"
        data-te-navbar-ref>
        <div class="flex flex-wrap items-center justify-between w-full px-6">
            ...
            <div class="!visible hidden flex-grow basis-[100%] items-center lg:!flex lg:basis-auto"
                ...
                <a class="flex items-center mt-2 mr-2 text-neutral-900 hover:text-neutral-900 focus:text-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:mt-0"
                    href="#">
                    <img src="https://tecdn.b-cdn.net/img/logo/mdb-transaprent-noshadows.png" style="height: 15px" alt=""
                        loading="lazy" />
                </a>
                <!-- Left links -->
